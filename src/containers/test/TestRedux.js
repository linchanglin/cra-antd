        ...
        return (
            <div style={{ height: '100px', background: '#ffc', padding: '10px' }}>
                <ul>
                    ...
                    <li>操作数值：
                        <button style={{ padding: '5px 10px' , backgroundColor: 'red'}} onClick={this.numberAdd.bind(this)}>+</button>
                        -------------------
                        <button style={{ padding: '5px 10px', backgroundColor: 'blue' }} onClick={this.numberSubtract.bind(this)}>-</button>
                    </li>
                </ul>
            </div>
        );
